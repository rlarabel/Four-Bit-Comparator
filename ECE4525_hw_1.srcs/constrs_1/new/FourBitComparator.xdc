...
set_property -dict { PACKAGE_PIN K15 IOSTANDARD LVCMOS33 } [get_ports { AgtB }]; #IO_L24P_T3_RS1_15 Sch=led[1]

set_property -dict { PACKAGE_PIN J13 IOSTANDARD LVCMOS33 } [get_ports { AltB }]; #IO_L17N_T2_A25_15 Sch=led[2]

set_property -dict { PACKAGE_PIN N14 IOSTANDARD LVCMOS33 } [get_ports { AeqB }]; #IO_L8P_T1_D11_14 Sch=led[3]
...
set_property -dict { PACKAGE_PIN M18 IOSTANDARD LVCMOS33 } [get_ports { cAgtB }]; #IO_L4N_T0_D05_14 Sch=btnu

set_property -dict { PACKAGE_PIN P17 IOSTANDARD LVCMOS33 } [get_ports { cAltB }]; #IO_L12P_T1_MRCC_14 Sch=btnl

set_property -dict { PACKAGE_PIN M17 IOSTANDARD LVCMOS33 } [get_ports { cAeqB }]; #IO_L10N_T1_D15_14 Sch=btnr
